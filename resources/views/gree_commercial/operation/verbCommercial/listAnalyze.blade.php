...
@section('breadcrumb')
    <ul class="breadcrumb">
        ...
        <li class="active">Verbas comerciais para aprovação</li>
    </ul><!-- End .breadcrumb -->
@endsection
...
@section('content')
                        ...
                        <table class="table table-bordered table-striped" id="tb1" data-rt-breakpoint="600">
                            ...
                            @foreach ($verb as $key)
                                <tr>
                                    ...
                                    <td>
                                        <select data-position="<?= $key->rtd_position ?>" json-data="<?= htmlspecialchars(json_encode($key), ENT_QUOTES, 'UTF-8') ?>" onchange="action(this)" class="simpleselect form-control">
                                            <option></option>
	...
	@include('gree_commercial.components.analyze.do_analyze.inputs', ['url' => '/commercial/sales/budget/analyze_do'])
    ...
    <script>
        ...
        $(document).ready(function () {
			...
			$("#budgetCommercialApprov").addClass('page-arrow active-page');
        });
    </script>
	<script src="/admin/app-assets/vendors/js/extensions/sweetalert2.all.min.js"></script>
	@include('gree_commercial.components.analyze.do_analyze.script')
