<div class="table-responsive">
    <table class="table table-bordered">
        ...
        <tr class="table-active">
            @foreach ($months as $value)
				<td style="text-align: center; background-color:#f7f7c8;" colspan="1">Qty</td>
            @endforeach
        </tr>
        ...
        <tr style="background: black;color: white;">
            ...
            @foreach ($months as $value)
                ...
                @endphp
            @endforeach
			<td style="text-align: center; background: black;color: white;" colspan="{{$colspan}}">{{$consumer->company_name}} - CPF/CNPJ: {{$consumer->identity}}</td>
        </tr>
        @php
            $line_exists = [];
            $line_jump = false;
        ...
        @foreach ($category as $value)
            <tr class="table-primary">
				<td style="text-align: center; background: #e8ecec;" colspan="4">{{$value['name']}}</td>
                @foreach ($months as $d)
                    @php
                    ...
                    @endphp
					<td style="text-align: center; background: #e8ecec;" colspan="1">{{$t_qtd}}</td>
                @endforeach
            </tr>
