@php
    function hasChanger($name, $arr, $type = 1) {
        if ($type == 1) {
    ...
    <div class="col-sm-12">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td colspan="12" class="td-text-center" >
                    <div class="inline-labels">
                        <label style="margin: 0px 125px 0px 0px;"><input type="radio" data-is-checked="1"  name="is_active" value="0" ><span></span> <span class="td-font-11 checkbtn">NOVO CLIENTE</span></label>
                        <label style="margin: 0px 125px 0px 0px;"><input type="radio" data-is-checked="0"  name="is_active" value="1" checked=""><span></span>  <span class="td-font-11 checkbtn">ATUALIZAÇÃO</span></label>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td class="{{hasChanger('company_name', $arr_client_diff)}} td-font-14" colspan="11">
            ...
            <tr>
                ...
                <td class="{{hasChanger('fantasy_name', $arr_client_diff)}} td-font-14" colspan="5">
                    @if (isset($client['fantasy_name']))
                        {{$client['fantasy_name']}}
                    @endif
                </td>
                <td class="td-title td-font-14 td-bold">
                ...
                <td class="{{hasChanger('client_on_group', $arr_relation_diff, 2)}} td-font-14" colspan="5">
                    @php $client_group = collect($client['client_group']); @endphp
                    @if ($client_group->count() > 0)
                        @php $group = collect($client_group->first()); @endphp
                        {{$group['name']}}
                    @endif
                </td>
            </tr>
            <tr>
                ...
                <td class="{{hasChanger('identity', $arr_client_diff)}} td-font-14 td-text-center" colspan="5">
                    {{$client['identity']}}
                </td>
                <td class="td-title td-font-14 td-bold">
                    I.E nº:
                </td>
                <td class="{{hasChanger('state_registration', $arr_client_diff)}} td-font-14 td-text-center" colspan="2">
                    {{$client['state_registration']}}
                </td>
                <td class="td-title td-font-14 td-bold">
                    I.M nº:
                </td>
                <td class="{{hasChanger('municipal_registration', $arr_client_diff)}} td-font-14 td-text-center" colspan="2">
            ...
            <tr>
                ...
                <td class="{{hasChanger('address', $arr_client_diff)}} td-font-14 td-text-center" colspan="4">
                    {{$client['address']}}
                </td>
                <td class="td-title td-font-14 td-bold">
                    Cidade:
                </td>
                <td class="{{hasChanger('city', $arr_client_diff)}} td-font-14 td-text-center">
                    {{$client['city']}}
                </td>
                <td class="td-title td-font-14 td-bold">
                    Estado:
                </td>
                <td class="{{hasChanger('state', $arr_client_diff)}} td-font-14 td-text-center">
                    {{$client['state']}}
                </td>
                <td class="td-title td-font-14 td-bold">
                    CEP:
                </td>
                <td class="{{hasChanger('zipcode', $arr_client_diff)}} td-font-14 td-text-center">
                    {{$client['zipcode']}}
                </td>
            </tr>
            <tr>
                ...
                <td class="{{hasChanger('code_description_ativity', $arr_client_diff)}} td-font-11" colspan="4">
                    {{$client['code_description_ativity']}}
                </td>
                <td class="td-title td-font-14 td-bold">
                    Insc. Suframa:
                </td>
                <td class="{{hasChanger('suframa_registration', $arr_client_diff)}} td-font-14 td-text-center" colspan="5">
            ...
            <tr>
                ...
                <td class="{{hasChanger('tax_regime', $arr_client_diff)}} td-font-11 td-text-center" colspan="10">
                    <div class="inline-labels">
                        <label><input type="radio" data-is-checked="1" name="tribute" value="1" @if ($client['tax_regime'] == 1) checked="" @endif><span></span> <span class="td-font-11 checkbtn">LUCRO REAL</span></label>
                        <label><input type="radio" data-is-checked="0" name="tribute" value="2" @if ($client['tax_regime'] == 2) checked="" @endif><span></span>  <span class="td-font-11 checkbtn">RESUMIDO</span></label>
                        <label><input type="radio" data-is-checked="0" name="tribute" value="3" @if ($client['tax_regime'] == 3) checked="" @endif><span></span>  <span class="td-font-11 checkbtn">SIMPLES</span></label>
                        <label><input type="radio" data-is-checked="0" name="tribute" value="4" @if ($client['tax_regime'] == 4) checked="" @endif><span></span>  <span class="td-font-11 checkbtn">PESSOA FÍSICA</span></label>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td class="{{hasChanger('especial_regime_icms_per_st', $arr_client_diff)}} td-font-14 td-text-center" colspan="10">
            ...
            <tr>
                ...
                <td class="{{hasChanger('billing_location_identity', $arr_client_diff)}} td-font-14" colspan="5">
                    {{$client['billing_location_identity']}}
                </td>
                <td class="{{hasChanger('delivery_location_identity', $arr_client_diff)}} td-font-14" colspan="6">
            ...
            <tr>
                ...
                <td class="{{hasChanger('billing_location_state_registration', $arr_client_diff)}} td-font-14" colspan="5">
                    {{$client['billing_location_state_registration']}}
                </td>
                <td class="{{hasChanger('delivery_location_state_registration', $arr_client_diff)}} td-font-14" colspan="6">
            ...
            <tr>
                ...
                <td class="{{hasChanger('billing_location_address', $arr_client_diff)}} td-font-14" colspan="5">
                    {{$client['billing_location_address']}}
                </td>
                <td class="{{hasChanger('delivery_location_address', $arr_client_diff)}} td-font-14" colspan="6">
            ...
            <tr>
                ...
                <td class="{{hasChanger('billing_location_city_state', $arr_client_diff)}} td-font-14" colspan="5">
                    {{$client['billing_location_city_state']}}
                </td>
                <td class="{{hasChanger('delivery_location_city_state', $arr_client_diff)}} td-font-14" colspan="6">
                    {{$client['delivery_location_city_state']}}
                </td>
            </tr>
            <tr>
                <td class="{{hasChanger('client_peoples_contact', $arr_relation_diff, 2)}} td-title td-font-14 td-bold td-text-center" rowspan="5">
                    Pessoa Contato
                </td>
            ...
            <tr>
                ...
                <td class="td-font-11" colspan="3">
                    @php $client_peoples_contact = collect($client['client_peoples_contact']); @endphp
                    @if ($client_peoples_contact->count() > 0)
                        @php ($contact = $client_peoples_contact->where('type_contact', 1)->first()) @endphp
                        @if ($contact)
                            {{$contact['name']}}
                        @endif
                    @endif
                ...
                <td class="td-font-11" colspan="3">
                    @if ($client_peoples_contact->count() > 0)
                        @php ($contact = $client_peoples_contact->where('type_contact', 2)->first()) @endphp
                        @if ($contact)
                            {{$contact['name']}}
                        @endif
                    @endif
                ...
                <td class="td-font-11" colspan="2">
                    @if ($client_peoples_contact->count() > 0)
                        @php ($contact = $client_peoples_contact->where('type_contact', 3)->first()) @endphp
                        @if ($contact)
                            {{$contact['name']}}
                        @endif
                    @endif
            ...
            <tr>
                <td class="{{hasChanger('client_owner_and_partner', $arr_relation_diff, 2)}} td-title td-font-14 td-bold td-text-center" rowspan="5">
            ...
            <tr>
                <td class="td-font-14" colspan="6">
                    @php $client_owner_and_partner = collect($client['client_owner_and_partner']); @endphp
                    @if ($client_owner_and_partner->count() > 0)
                        @php ($contact = $client_owner_and_partner->first()) @endphp
                        @if ($contact)
                            {{$contact['name']}}
                        @else
            ...
            <tr>
                <td class="td-font-14" colspan="6">
                    @if ($client_owner_and_partner->count() > 0)
                        @php ($contact = $client_owner_and_partner->slice(1)->first()) @endphp
                        @if ($contact)
                            {{$contact['name']}}
                        @else
                            <div class="spacer-10"></div>
            ...
            <tr>
                <td class="td-font-14" colspan="6">
                    @if ($client_owner_and_partner->count() > 0)
                        @php ($contact = $client_owner_and_partner->slice(2)->first()) @endphp
                        @if ($contact)
                            {{$contact['name']}}
                        @else
                            <div class="spacer-10"></div>
            ...
            <tr>
                <td class="td-font-14" colspan="6">
                    @if ($client_owner_and_partner->count() > 0)
                        @php ($contact = $client_owner_and_partner->slice(3)->first()) @endphp
                        @if ($contact)
                            {{$contact['name']}}
                        @else
                            <div class="spacer-10"></div>
            ...
            <tr>
                ...
                <td class="{{hasChanger('social_capital', $arr_client_diff)}} td-font-14 td-text-center" colspan="4">
                    <b>R$ {{number_format($client['social_capital'], 2, ',', '.')}}</b>
                </td>
                <td class="td-title td-font-14 td-bold" colspan="3">
                    Junta Com. (NIRE) nº:
                </td>
                <td class="{{hasChanger('nire_number', $arr_client_diff)}} td-font-14 td-text-center" colspan="4">
                    {{$client['nire_number']}}
                </td>
            </tr>
            <tr class="{{hasChanger('type_client', $arr_client_diff)}}">
            ...
            <tr class="{{hasChanger('type_client', $arr_client_diff)}}">
                <td class="td-font-14" colspan="4">
                    ...
                    <br><label style="margin: 0px 0px 0px 20px;"><input type="radio" data-is-checked="0" name="type_client" value="1" @if($client['type_client'] == 6) checked="" @endif><span></span>  <span class="td-font-11 checkbtn">VAREJO NACIONAL</span></label>
                </td>
            ...
            <tr class="{{hasChanger('client_on_product_sales', $arr_relation_diff, 2)}}">
            ...
            <tr>
                ...
                <td class="{{hasChanger('quantity_filial_cds', $arr_client_diff)}} td-font-14" colspan="9">
            ...
            <tr>
                <td class="{{hasChanger('billing_last_years', $arr_client_diff)}} td-font-14 td-text-center" colspan="2">
                    {{$client['billing_last_years']}}
                </td>
                <td class="{{hasChanger('units_air_sold_last_years', $arr_client_diff)}} td-font-14 td-text-center" colspan="3">
                    {{$client['units_air_sold_last_years']}}
                </td>
                <td class="{{hasChanger('billing_air_last_years', $arr_client_diff)}} td-font-14 td-text-center" colspan="2">
                    {{$client['billing_air_last_years']}}
                </td>
                <td class="{{hasChanger('purchase_volume', $arr_client_diff)}} td-font-14 td-text-center" colspan="2">
                    {{$client['purchase_volume']}}
                </td>
                <td class="{{hasChanger('works_import', $arr_client_diff)}} td-font-14 td-text-center" colspan="3">
            ...
            <tr class="{{hasChanger('client_documents', $arr_relation_diff, 2)}}">
                @php $client_documents = collect($client['client_documents']); @endphp
