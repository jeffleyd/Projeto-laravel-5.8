...
<ul class="breadcrumb">
    ...
    <li><a href="/commercial/order/approv">Solicitações de aprovação</a></li>
    <li class="active">Análisando pedido programado</li>
</ul><!-- End .breadcrumb -->
@endsection
...
<div class="window">
    <div class="actionbar">
        <div class="pull-left">
            ...
            <ul class="ext-tabs">
                <li class="active">
                    <a href="#content-tab-1">Pedido programado para aprovação</a>
                </li>
                <li class="">
                ...
                <li onclick="window.open('/commercial/programation/view/{{$order->programationMonth->programation_id}}?order_id={{$order->id}}', '_blank')">
                    <a href="javascript:void(0)">Ver programação</a>
                </li>
				<li class="">
    ...
    <div class="tab-content">
        <div id="content-tab-1" class="tab-pane active">
            <div class="inner-padding">
                <div class="row">
                    <div class="col-sm-12">
                        <fieldset>
                            <iframe style="width: 100%; height: 1600px;" src="/commercial/order/print/view/{{$order->id}}"></iframe>
                        </fieldset>
		...
		<div id="content-tab-5" class="tab-pane">
			<div class="inner-padding">
				@include('gree_commercial.components.products_mix', [
				'order' => $order, 
