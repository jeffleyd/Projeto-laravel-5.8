        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Não programados</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="card-body p-b-0">
                    <ul class="nav nav-tabs customtab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active tab1" data-toggle="tab" href="#tab1" role="tab">
                                ...
                                <span class="hidden-xs-down">Pedido para aprovação</span>
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active p-20" id="tab1" role="tabpanel">
                            <iframe style="width: 100%; height: 1600px; border:1px;" src="/comercial/operacao/order/confirmed/print/view/{{$order->id}}"></iframe>
                        </div>
                        ...
                        <div class="tab-pane p-20" id="tab8" role="tabpanel">
							@include('gree_commercial_external.components.products_mix', ['order' => $order, 'categories' => json_decode($order->json_categories_products, true)])
                        </div>
                    </div>
                </div>
            </div>
