...
@section('page-breadcrumb')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Lista de pedidos</h4>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif ($key->waiting_assign == 1)
                                            <span data-toggle="tooltip" title="" data-original-title="Você precisa comprovar a solicitação do pedido." class="label label-info">Aguardando Comprovação <i class="ti ti-help-alt alt-question"></i></span>
...
<div id="receiverAssignModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/comercial/operacao/order/proof" method="POST" id="formSign">
...
<div id="exportModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Exportar pedidos não programados</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <form action="/comercial/operacao/order/export" id="exportData">
                    <div class="row">
						<div class="col-sm-12 form-group">
...
@section('page-scripts')
    ...
    var orderid;
        function action($this = '') {
            ...
            if ($this == '') {
                window.location.href = '/comercial/operacao/order/confirmed/new';
            }
            var json = JSON.parse($($this).attr('json-data'));
            if ($($this).val() == 2) {
				window.open(json.url_view_proof, '_blank');
            } else if ($($this).val() == 6) {
                window.open('/comercial/operacao/order/confirmed/print/view/'+json.id, '_blank');
            } else if ($($this).val() == 1) {
                ...
                window.open('/comercial/operacao/order/confirmed/print/view/'+json.id+'?chide=true', '_blank');
            } else if ($($this).val() == 5) {
