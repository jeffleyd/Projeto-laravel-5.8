    ...
    <div class="col-sm-12">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td class="td-font-14 td-text-center" colspan="2">
                    <label style="margin: 0px 25px 0px 0px;"><input type="radio" data-is-checked="1" name="import" value="0" @if($client->works_import == 1) checked="" @endif><span></span> <span class="td-font-11 checkbtn">SIM</span></label>
            ...
            <tr>
                ...
                <td style="padding: 0px 55px" class="td-font-14" colspan="12">
                    ...
                    <div style="float: left; margin: 5px 0;">
                        ...
                        <br><label style="margin-right: 10px"><input type="checkbox" data-is-checked="0" name="document" value="1" @if ($client_documents->count() > 0) @if(findCollect($client_documents, 2, 'card_cnpj')) checked="" @endif @endif><span></span>  <span class="td-font-11">CARTÃO CNPJ (Receita Federal)</span></label>
                    </div>
