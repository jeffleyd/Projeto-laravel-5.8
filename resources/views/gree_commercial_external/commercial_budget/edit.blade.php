...
@section('page-breadcrumb')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Editando a solicitação: {{$budget->code}}</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <a class="btn btn-info d-none d-lg-block m-l-15" onclick="saveVerb()" href="#">
                    <i class="fa fa-check"></i> Salvar verba comercial
                </a>
            </div>
        </div>
    </div>
...
@section('content')
<form action="/comercial/operacao/verba-comercial/editar/salvar" id="sendVerb" method="post" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-body">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item duplicate" @if ($budget->type_payment != 2) style="display: none" @endif> <a class="nav-link" data-toggle="tab" href="#duplicate" role="tab"><span class="hidden-sm-up"><i class="ti-receipt"></i></span> <span class="hidden-xs-down">Duplicatas</span></a> </li>
                    <li class="nav-item transition_bank" @if ($budget->type_payment != 3) style="display: none" @endif> <a class="nav-link" data-toggle="tab" href="#transition_bank" role="tab"><span class="hidden-sm-up"><i class="ti-money"></i></span> <span class="hidden-xs-down">Dados bancários</span></a> </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 form-group ">
                                        ...
                                        <select name="type_document" id="type_document" class="form-control">
                                            <option value=""></option>
                                            <option value="1" @if ($budget->type_documents == 1) selected @endif>NF débito</option>
                                            <option value="2" @if ($budget->type_documents == 2) selected @endif>NF Devolução</option>
                                            <option value="3" @if ($budget->type_documents == 3) selected @endif>NF Produto</option>
                                            <option value="4" @if ($budget->type_documents == 4) selected @endif>Pedido do cliente</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-12 form-group">
                                        ...
                                        <p><small>Caso anexe novamente os documentos, irá excluir os anteriores.</small></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12 p-4">
                                <div class="row">
                                    <div class="col-12 col-sm-12 form-group ">
                                        ...
                                        <input type="text" name="nf" value="{{$budget->transf_bank}}" id="nf" class="form-control">
                                    </div>
                                    <div class="col-12 col-sm-4 form-group ">
                                        <label class="bank">Banco</label>
                                        <input type="text" name="bank" value="{{$budget->transf_bank}}" id="bank" class="form-control">
                                    </div>
                                    <div class="col-12 col-sm-4 form-group ">
                                        <label class="agency">Agência</label>
                                        <input type="text" name="agency" value="{{$budget->transf_agency}}" id="agency" class="form-control">
                                    </div>
                                    <div class="col-12 col-sm-4 form-group ">
                                        <label class="account">Conta</label>
                                        <input type="text" name="account" value="{{$budget->transf_account}}" id="account" class="form-control">
                                    </div>
                                    <div class="col-12 col-sm-6 form-group ">
                                        <label class="people_name">Títular da conta</label>
                                        <input type="text" name="people_name" value="{{$budget->transf_people_name}}" id="people_name" class="form-control">
                                    </div>
                                    <div class="col-12 col-sm-6 form-group ">
                                        <label class="identity">CNPJ</label>
                                        <input type="text" name="identity" value="{{$budget->transf_identity}}" id="identity" class="form-control">
                                    </div>
                                    <div class="col-12 col-sm-6 form-group ">
                                        <label class="identity">Total bruto do pagamento</label>
                                        <input type="text" name="total_gross_payment" value="{{number_format($budget->total_gross_payment, 2, ',', '.')}}" id="identity" class="form-control price">
                                    </div>
                                    <div class="col-12 col-sm-6 form-group ">
                                        <label class="identity">Total liquido do pagamento</label>
                                        <input type="text" name="total_liquid_payment" value="{{number_format($budget->total_liquid_payment, 2, ',', '.')}}" id="identity" class="form-control price">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 form-group ">
                                ...
                                <select name="type_request" id="type_request" class="form-control">
                                    <option value=""></option>
                                    <option value="1" @if ($budget->type_payment == 1) selected @endif>Produto</option>
                                    <option value="2" @if ($budget->type_payment == 2) selected @endif>Desconto em duplicata/Título em aberto</option>
                                    <option value="3" @if ($budget->type_payment == 3) selected @endif>Transação bancária</option>
                                </select>
                            </div>
                            <div class="col-12 col-sm-6 form-group">
                                ...
                                <select name="type_budget" id="type_budget" class="form-control">
                                    <option value=""></option>
                                    <option value="1" @if ($budget->type_budget == 1) selected @endif>VPC</option>
                                    <option value="2" @if ($budget->type_budget == 2) selected @endif>Rebate</option>
                                    <option value="3" @if ($budget->type_budget == 3) selected @endif>Bonificação</option>
                                    <option value="4" @if ($budget->type_budget == 4) selected @endif>Verbas contratuais</option>
                                    <option value="5" @if ($budget->type_budget == 5) selected @endif>Desconto</option>
                                </select>
                            </div>
                            <div class="col-12 col-sm-12 form-group reportVPC" style="display: none">
                                ...
                                <select id="reportVPC" class="form-control" name="reportVPC">
                                    ...
                                    @foreach($reportVPC as $key)
                                        @if ($budget->type_budget == 1)
                                            <option value="{{$key->id}}" @if ($key->id == $budget->budget_commercial_report->id) selected @endif>({{$key->code}}) {{$key->client_group_name}}</option>
                                        @else
                            ...
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <div style="width: 100%; display: flex; justify-content: center; position: absolute; bottom: -55px">
                                        ...
                                        <button type="button" style="@if ($budget->budget_commercial_itens->count() < 2) display: none; @endif margin-left: 15px;" id="r_remove" onclick="removeRow()" class="btn btn-danger btn-circle">
                                    ...
                                    <table class="table table-bordered" style="margin-bottom: 0;">
                                        ...
                                        @else
                                            @foreach ($budget->budget_commercial_itens as $index => $item)
                                                @php
                                                    $total += $item->sub_total;
                                                @endphp
                                                <tr>
                                                    <td colspan="3" style="text-align: center">
                                                        <input style="width: 100%;" class="input-td" placeholder="Digite aqui..." type="text" value="{{$item->description}}" name="request_col_1[{{$index+1}}]">
                                                    </td>
                                                    <td class="text-center">
                                                        <input style="width: 50px;" class="text-center input-td quantity" onkeyup="r_calc(this)" type="text" name="request_col_2[{{$index+1}}]" placeholder="0" value="{{$item->quantity}}">
                                                    </td>
                                                    <td style="text-align: center">
                                                        <input class="text-center input-td" placeholder="-" style="text-transform: uppercase" type="text" name="request_col_3[{{$index+1}}]" value="{{$item->unity}}">
                                                    </td>
                                                    <td style="text-align: center">
                                                        R$ <input class="input-td price" placeholder="0,00" onkeyup="r_calc(this)" type="text" name="request_col_4[{{$index+1}}]" value="{{number_format($item->price_unit,2,',','.')}}">
                                                    </td>
                                                    <td style="text-align: center;width:210px" id="row_total_{{$index+1}}">R$ {{number_format($item->sub_total,2,',','.')}}</td>
                                                    <input name="request_col_5[{{$index+1}}]" type="hidden">
                                                </tr>
                                            @endforeach
                                        @endif
                                        </tbody>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;background: #e4e4e4;"></td>
                                            <td style="text-align: center;background: #e4e4e4;"></td>
                                            <td style="width:210px;text-align: center;font-weight: 600;font-size: 15px;" id="total_general">R$ {{number_format($total,2,',','.')}}</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <div style="width: 100%; display: flex; justify-content: center; position: absolute; bottom: -55px">
                                        ...
                                        <button type="button" style="@if ($budget->budget_commercial_duplicates->count() < 2) display: none; @endif margin-left: 15px;" id="d_remove" onclick="removeRowDuplicate()" class="btn btn-danger btn-circle">
                                            <i class="fa fa-times"></i>
                                        </button>
                                    </div>
                                    <table class="table table-bordered" style="margin-bottom: 0;">
                                        ...
                                        @else
                                            @foreach ($budget->budget_commercial_duplicates as $index => $item)
                                                <tr>
                                                    <td style="text-align: center">
                                                        <input style="width: 100%;" class="input-td" placeholder="Digite aqui..." value="{{$item->nf_number}}" type="text" name="duplicate_col_1[{{$index+1}}]">
                                                    </td>
                                                    <td style="text-align: center">
                                                        <input style="width: 100%;" class="input-td" placeholder="Digite aqui..." value="{{$item->nf_serie}}" type="text" name="duplicate_col_2[{{$index+1}}]">
                                                    </td>
                                                    <td style="text-align: center">
                                                        <input style="width: 100%;" class="input-td" placeholder="Digite aqui..." value="{{$item->parcel_number}}" type="text" name="duplicate_col_3[{{$index+1}}]">
                                                    </td>
                                                    <td style="text-align: center">
                                                        <input style="width: 100%;" class="input-td date" placeholder="DIA/MES/ANO" value="@if ($item->due_date) {{date('d/m/Y', strtotime($item->due_date))}} @endif" type="text" name="duplicate_col_4[{{$index+1}}]">
                                                    </td>
                                                    <td style="text-align: center">
                                                        R$ <input class="input-td price" placeholder="0,00" type="text" value="{{number_format($item->parcel_price,2,',','.')}}" name="duplicate_col_5[{{$index+1}}]">
                                                    </td>
                                                    <td style="text-align: center">
                                                        R$ <input class="input-td price" placeholder="0,00" type="text" value="{{number_format($item->price_descoint,2,',','.')}}" name="duplicate_col_6[{{$index+1}}]">
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @endif
                    ...
                    <div class="tab-pane  p-20" id="observation" role="tabpanel">
                        <div class="row">
                            <div class="col-sm-12 form-group ">
                                ...
                                <textarea name="observation" id="observation" class="form-control" rows="5" placeholder="Caso tenha alguma coisa a dizer, digite aqui...">{{$budget->observation}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('page-scripts')
    ...
    <script type="text/javascript">
        var r_index = @if($budget->budget_commercial_itens->count() < 2) 2 @else {{$budget->budget_commercial_itens->count() + 1}} @endif;
        var d_index = @if($budget->budget_commercial_duplicates->count() < 2) 2 @else {{$budget->budget_commercial_duplicates->count() + 1}} @endif;
