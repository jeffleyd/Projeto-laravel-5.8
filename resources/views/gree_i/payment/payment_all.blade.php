                                ...
                                <div class="table-responsive">
                                            ...
                                            <td id="action">
                                                <div class="dropleft">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a href="/financy/payment/request/print/<?= $key->id ?>"  target="_blank" class="dropdown-item" href="javascript:void(0)"><i class="bx bx-printer mr-1"></i> Imprimir</a>
                                                        <?php if ($key->has_analyze == 0 and $key->is_paid == 0 and !$relation) { ?>
                                                        <a href="/financy/payment/edit/<?= $key->id ?>" class="dropdown-item" href="javascript:void(0)"><i class="bx bx-edit-alt mr-1"></i> Editar</a>
                                                        <?php } ?>
                                                        <?php if ($key->receipt) { ?>
                                                        ...
                                                        @if ($relation)
                                                            <a class="dropdown-item" target="_blank" href="{{$key->relationModules($relation)['url']}}"><i class="bx bx-show-alt mr-1"></i> Ver solicit.</a>
                                                        @endif
                                    ...
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination justify-content-end">
                                            <?= $payment->appends(['r_code' => Session::get('paymentf_r_code'), 'id' => Session::get('paymentf_id'), 'nf' => Session::get('paymentf_nf')])->links(); ?>
                                        </ul>
                                    </nav>
                                </div>
                                <!-- datatable ends -->
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            setInterval(() => {
                ...
                $("#mFinancyPaymentAll").addClass('active');
            }, 100);
