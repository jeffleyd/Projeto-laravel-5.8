              ...
              <div class="row breadcrumbs-top">
                <div class="col-12">
                  ...
                  <div class="breadcrumb-wrapper col-12">
                      Análisando solicitação: #<?= $r_payment->code ?>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="card-content">
            ...
            <div class="row">
                <div class="col-sm-12 d-flex justify-content-center">
                    <button type="button" data-toggle="modal" data-target="#modal-approv" class="btn btn-success min-width-125 mr-1">REALIZAR ANÁLISE</button>
                </div>
