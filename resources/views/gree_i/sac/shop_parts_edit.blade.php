...
<div class="content-overlay"></div>
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-12 mb-2 mt-1">
              <div class="row breadcrumbs-top">
                <div class="col-12">
                  <h5 class="content-header-title float-left pr-1 mb-0">Lojas depeças</h5>
                  <div class="breadcrumb-wrapper col-12">
                    @if ($id == 0)
                    Nova loja de peças
                    @else
                    Atualizar loja de peças: {{ $code }}
                    @endif
                  </div>
                </div>
              </div>
        ...
        <div class="content-body">
            <form class="needs-validation" action="/sac/register/shop-parts/edit_do" id="submitEdit" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
							...
							<div class="col-md-12">
                                <fieldset class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="site" id="site" value="{{ $site }}" placeholder="Digite o site.">
                                </fieldset>
                            </div>
