...
<div class="content-overlay"></div>
    <div class="content-wrapper">
        ...
        <div class="content-body">
            <form class="needs-validation" action="/sac/register/shop/edit_do" id="submitEdit" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="phone" name="phone_1" value="{{ $phone }}" required>
                                </fieldset>
                            </div>
