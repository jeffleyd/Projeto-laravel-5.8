...
<div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-12 mb-2 mt-1">
          <div class="row breadcrumbs-top">
            <div class="col-12">
              <h5 class="content-header-title float-left pr-1 mb-0">Lojas</h5>
    ...
    <div class="content-body">
        <div class="users-list-filter px-1">
            <form action="/sac/register/shop/all" id="searchTrip" method="GET">
                                ...
                                <table id="list-datatable" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/sac/register/shop/edit/<?= $key->id ?>"><i class="bx bx-edit-alt mr-1"></i></a>
                                            </td>                                          
                                        </tr>
                                        <?php } ?>
                                    </tbody>
...
<div class="mb-2" style="width: 390px; position: fixed;left: 0;right: 0;bottom: 0;margin: 0 auto; z-index: 99; text-align: center;">
    <button type="button" onclick="window.location.href = '/sac/register/shop/edit/0'" class="btn btn-sm btn-secondary">Nova loja</button>
</div>
    <script>
    $(document).ready(function () {
        ...
        $(".js-select21").select2({
            ...
            $("#mSacRegisterShop").addClass('active');
        }, 100);
