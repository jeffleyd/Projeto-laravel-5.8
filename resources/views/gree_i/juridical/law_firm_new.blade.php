...
<div class="content-overlay"></div>
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item current">
                                        <a class="nav-link active" data-toggle="tab" href="#law" aria-controls="law" role="tab" aria-selected="true">
                                            <i class="bx bx-spreadsheet align-middle"></i>
                                            <span class="align-middle">Dados principais</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#contact" aria-controls="contact" role="tab" aria-selected="false">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="law" aria-labelledby="law-tab" role="tabpanel">
                                        <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-2">
                                                <fieldset class="form-group">
                                                    ...
                                                    <select name="type_people" id="type_people" class="form-control">
                                                        ...
                                                        <option value="2" >Pessoa Juridica (CNPJ)</option>
                                                    </select>
                                                </fieldset>
                                            </div>
                                            <div class="col-md-10">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="address" name="address" placeholder="Informe o endereço" required>
                                                </fieldset>
                                            </div>
                                        </div>    
                                        <div class="row">    
                                        ...
                                        <div class="row">    
                                            <div class="col-md-12">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="complement" name="complement" placeholder="Bloco D apto 108">
                                                </fieldset>
                                            </div>
                                        </div>   
                                        <br>
                                                    ...
                                                    <li class="d-inline-block mr-2">
                                                        <fieldset>
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" class="custom-control-input" value="1" name="is_active" id="active" checked="">
                                    ...
                                    <div class="tab-pane" id="contact" aria-labelledby="contact-tab" role="tabpanel">
                                        <div class="row" style="margin-bottom:20px;">
                                            <div class="col-md-8">
                                                <p style="position: relative; top: 10px;">Após adicionar os contatos é necessário salvar.</p>
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <tbody id="table_contacts">
                                                <tr>
                                                    <td colspan="4" class="text-bold-200">Não há contatos adicionados!</td>
                                                </tr>
                                            </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div class="tab-pane" id="bank_tab" aria-labelledby="bank-tab" role="tabpanel">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <tbody id="table_bank">
                                                <tr>
                                                    <td colspan="4" class="text-bold-200">Não há contas bancárias adicionadas!</td>
                                                </tr>
                                            </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button type="button" id="new_office" class="btn btn-primary" style="width:100%;">Criar Escritório</button>
                                        </div>
                                    </div>
                                </div>
                            </div>               
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#btn_add_contact").click(function(){
                ...
                if($("#contact_name").val() == "") {
                    ...
                    $('#table_contacts').html(genContactHtml(arr_contact));
        ...
        function genContactHtml(object) {
            var html = '';
