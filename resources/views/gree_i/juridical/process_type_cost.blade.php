            ...
            <div class="users-list-table">
                <div class="card">
                    <div class="card-content">
                        <form action="/juridical/type/cost/list" method="GET">
                            <div class="card-body">
                                <div class="top d-flex flex-wrap">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control"  name="description" id="filter_description" placeholder="Filtrar tipo custo">
                                                    </div>
                                                </div>    
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                    ...
                                    <div class="actions action-btns d-flex align-items-center">
                                        ...
                                        <div class="dropdown invoice-options">
                                            <button type="button" class="btn btn-success shadow mr-1" onclick="typeEdit(0, 1, '', '')"><i class="bx bx-plus-circle"></i> Novo Custo</button>
                                        </div>
                                    </div>
                                </div>
                            </div> 
                            ...
                            <div class="table-responsive">
                                ...
                                <nav aria-label="Page navigation">
                                    <ul class="pagination justify-content-end">
                                        <?= $type_cost->appends([
                                                'description' => Session::get('type_cost_description'),
                                                'status' => Session::get('type_cost_status'),
                                            ])->links(); 
                                        ?>
                                    </ul>
                                </nav>
...
<script>
    ...
    function typeEdit(id, is_new, description, status) {
        ...
        if (is_new == 1) {
            $(".modal-title").html("Novo tipo de custo");
            $("#description").val('');
            ...
            $(".modal-title").html("Editando Custo");
