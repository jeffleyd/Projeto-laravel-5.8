...
<div class="content-wrapper">
    ...
    <div class="content-body">
        <div class="row">
            <div class="col-xl-3 col-md-12 cursor-pointer" onclick="window.location.href = '/qr_code/list/all?not_approved=1'">
                <div class="card text-center">
                    <div class="card-content">
                        <div class="card-body">
                            <h2 class="mb-0">{{$not_approved}}</h2>
                            <p class="text-muted mb-0 line-ellipsis">Solicitações que <br> faltam aprovar<br></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-12 cursor-pointer" onclick="window.location.href = '/qr_code/list/all?approved_not_apm=1'">
                <div class="card text-center">
                    <div class="card-content">
                        <div class="card-body">
                            <h2 class="mb-0">{{$approved_not_apm}}</h2>
                            <p class="text-muted mb-0 line-ellipsis">Aprovado e sem <br> protocolo</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-12 cursor-pointer" onclick="window.location.href = '/qr_code/list/all?request_without_expert=1'">
                <div class="card text-center">
                    <div class="card-content">
                        <div class="card-body">
                            <h2 class="mb-0">{{$request_without_expert}}</h2>
                            <p class="text-muted mb-0 line-ellipsis">Com protocolo, mas <br> sem autorizada</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-12 cursor-pointer" onclick="window.location.href = '/qr_code/list/all?request_without_expert_left_5=1'">
                <div class="card text-center">
                    <div class="card-content">
                        <div class="card-body">
                            <h2 class="mb-0">{{$request_without_expert_left_5}}</h2>
                            <p class="text-muted mb-0 line-ellipsis">Com protocolo, mas sem <br> autorizada há 15 dias</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12 col-sm-12 col-lg-3">
                        ...
                        <fieldset class="form-group">
                            <select class="form-control" name="status" id="status">
                                <option value=""></option>
                                <option value="1" @if (Session::get('filter_status') ==1 ) selected @endif >Aguardando Análise</option>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($qrcode as  $index => $item)
                                            ...
                                            <tr class="cursor-pointer showDetails">
                                                ...
                                                <td colspan="3"> {!!$item->status_text!!}</td>
                                                ...
                                                <td class="no-click">
                                                    <div class="dropleft">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a class="dropdown-item" target="_blank" href="/sac/warranty/interactive/<?= $key->sac_protocol_id ?>"><i class="bx bx-chat mr-1"></i> Interagir</a>
                                                            @endif
                                                ...
                                                <td colspan="9">
                                                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                                            <li class="nav-item current">
                                                                <a class="nav-link active" id="home-tab-justified" data-toggle="tab" href="#home-just_{{$index+1}}" role="tab" aria-controls="home-just" aria-selected="true">
                                                                Dados
                                                                </a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link" id="profile-tab-justified" data-toggle="tab" href="#profile-just_{{$index+1}}" role="tab" aria-controls="profile-just" aria-selected="false">
                                                                Equipamentos
                                                                </a>
                                                            </li>
                                                        </ul>
                                                        <div class="tab-content pt-1">
                                                            <div class="tab-pane active" id="home-just_{{$index+1}}" role="tabpanel" aria-labelledby="home-tab-justified">
                                                            ...
                                                            <div class="tab-pane" id="profile-just_{{$index+1}}" role="tabpanel" aria-labelledby="profile-tab-justified">

                                                                <div class="col-md-12">
                                                                    <div class="row">
                                                                        @foreach($item->products as $index_p => $produto)
                                                                            <div class="col-5 mt-1 bg-primary bg-lighten-1 text-white cursor-pointer" style="padding: 15px;margin-right: 25px;border-radius: 10px; height: auto;">
                                                                                <p style="margin: 0;"><b>Modelo:</b> {{$produto->model_name}}
                                                                                <br><b>N Série:</b> {{$produto->serial_number}} </p>
                                                                                <br><b>Endereço:</b> {{$produto->address}}
                                                                                <br><b>Complemento:</b> {{$produto->complement}}
                                                                            </div>
                                                                        @endforeach
                                                                    </div>
                                                                </div>
    ...
    <script>
        ...
        setInterval(() => {
            ...
            $("#mQRCodeListAll").addClass('active');
        }, 100);
