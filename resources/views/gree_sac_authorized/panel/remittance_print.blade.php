        ...
        <div id="conteudo">
            ...
            <div id="bloco">
                ...
                @if (count($remitance_parts) > 0)              
                    ...
                    <div class=" fl-left" style=" width: 20%; text-align: center; background-color: #ccc;  padding: 10px">Motivo Solicitação</div>
                    <div class=" fl-left" style=" width: 20%; text-align: center; background-color: #ccc;  padding: 10px">Quantidade</div>
                    <div class=" fl-left" style=" width: 10%; text-align: center; background-color: #ccc;  padding: 10px">Status</div>
                    <div class="limpar"></div>
                    ...
                    @foreach ($remitance_parts as $key)
                        ...
                        <div class=" fl-left" style=" width: 20%; text-align: center; padding: 10px"><?= $key->description_order_part ?></div>
                        <div class=" fl-left" style=" width: 20%; text-align: center; padding: 10px"><?= $key->quantity ?></div>
                        <div class=" fl-left" style=" width: 10%; text-align: center; padding: 10px">
                            @if($key->is_repprov == 1)
                                <div style="color: #d00102;">Reprovado</div>
                            @endif    
                            @if($key->is_approv == 1)     
                                <div style="color:#30c57b;">Aprovado</div>
                            @endif    
                        </div>    
                        <div class="limpar"></div>
                    @endforeach
