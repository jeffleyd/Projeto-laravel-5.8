...
<div class="hero-static content content-full bg-white js-appear-enabled animated fadeIn" data-toggle="appear">
    <div class="py-30 px-5 text-center">
        ...
        <h1 class="h2 font-w700 mt-50 mb-10">Não se preocupe!</h1>
        <h2 class="h4 font-w400 text-muted mb-0">Digite seu CNPJ abaixo</h2>
    </div>
    <div class="row justify-content-center px-5">
        <div class="col-sm-8 col-md-6 col-xl-4">
            <form action="/autorizada/esqueci_do" id="formSend" method="post">
                ...
                <div class="form-group row gutters-tiny">
                    ...
                    <div class="col-sm-12 mb-5">
                        <a class="btn btn-block btn-noborder btn-rounded btn-alt-secondary" href="/autorizada">
                            Voltar ao acesso</a>
                    </div>
                </div>
            </form>
    ...
    $(document).ready(function () {
        ...
        $("#formSend").submit(function (e) {
            if ($("#email").val() == "") {
                ...
                e.preventDefault();
                return error('É necessário o cnpj de cadastro para buscarmos em nossa base.');
            }
