...
<body class="horizontal-nav skin-megna fixed-layout">
    ...
    <div id="main-wrapper">
        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-header" style="width: 225px;">
                    <a class="navbar-brand" href="/promotor/dashboard">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="@if (Session::get('promoter_data')->picture == "") /media/avatars/avatar10.jpg @else {{Session::get('promoter_data')->picture}} @endif" alt="user" class=""> <span class="hidden-md-down">{{Session::get('promoter_data')->name}} &nbsp;<i class="fa fa-angle-down"></i></span> </a>
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                <!-- text-->
                                <div class="dropdown-divider"></div>
                                <!-- text-->
                                <a href="/promotor/logout" class="dropdown-item"><i class="fa fa-power-off"></i> Sair</a>
                                <!-- text-->
                            </div>
                        </li>
                        <!-- ============================================================== -->
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><img src="@if (Session::get('promoter_data')->picture == "") /media/avatars/avatar10.jpg @else {{Session::get('promoter_data')->picture}} @endif" alt="user-img" class="img-circle"><span class="hide-menu">{{Session::get('promoter_data')->name}}</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="/promotor/logout"><i class="fa fa-power-off"></i> Sair</a></li>
                            </ul>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="/promotor/dashboard" aria-expanded="false"><i class="ti-location-pin"></i><span class="hide-menu">Roterização</span></a></li>
                        <li> <a class="waves-effect waves-dark" href="/promotor/request/item" aria-expanded="false"><i class="ti-receipt"></i><span class="hide-menu">Requisitar material</span></a></li>
        ...
        <!-- footer -->
        <!-- ============================================================== -->
        <div id="notpermission" class="p-1 text-center bg-danger text-white" onclick="requestPermissionLocation()">Localização não foi habilitada, clique aqui para habilitar!</div>
        <footer class="footer">
