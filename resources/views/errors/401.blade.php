                    ...
                    <div class="hero-inner">
                        <div class="content content-full">
                            <div class="py-30 text-center">
                                ...
                                <h1 class="h2 font-w700 mt-30 mb-10">AUTORIZAÇÃO NEGADA!</h1>
                                <h2 class="h3 font-w400 text-muted mb-50">Você precisa estar em uma rede de conexão autorizada da <br><b>GREE DO BRASIL</b></h2>
                            </div>
                        </div>
                    </div>
                </div>
