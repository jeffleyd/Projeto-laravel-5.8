                    ...
                    <div class="hero-inner">
                        <div class="content content-full">
                            <div class="py-30 text-center">
                                ...
                                <h1 class="h2 font-w700 mt-30 mb-10">Oops.. Você encontrou um erro na página...</h1>
                                <h2 class="h3 font-w400 text-muted mb-50">A nossa equipe de desenvolvimento já está trabalhando nesse erro, não se preocupe! Volte em alguns minutos.</h2>
                                <a class="btn btn-hero btn-rounded btn-alt-secondary" href="<?= URL::previous(); ?>">
                                    <i class="fa fa-arrow-left mr-10"></i> Voltar para o seguro
                                </a>
                            </div>
                        </div>
                    </div>
